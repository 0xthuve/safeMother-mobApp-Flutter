...
class _FoodScanPageState extends State<FoodScanPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Food Safety Scanner', style: GoogleFonts.poppins()),
                ...
                children: [
                  ...
                  if (result['nutrition'] != null &&
                    ...
                    _buildTag('Nutrition: ${result['nutrition']['level']}',
                        Colors.orange),
                  _buildTag(category, const Color(0xFF7B1FA2)),
                ],
              ),
            ],
          ),
    ...
    return Container(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Icon(Icons.error_outline, color: Color(0xFFE91E63), size: 24),
              SizedBox(width: 12),
              Expanded(
                child: Text(
                  message,
            ...
            children: [
              ...
              Wrap(
                ...
                children: _detectedLabels
                    .map((label) => _buildTag(label, const Color(0xFF7B1FA2)))
                    .toList(),
              ),
              SizedBox(height: 8),
              Text(
