...
class _DoctorSettingsState extends State<DoctorSettings> {
  ...
  Widget _switchTile({required IconData icon, required String title, required bool value, required ValueChanged<bool> onChanged}) => ListTile(
        ...
        trailing: Switch(value: value, onChanged: onChanged, activeColor: const Color(0xFFE91E63)),
      );
  ...
  void _toast(String msg) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(msg), backgroundColor: const Color(0xFFE91E63)));
  }
}
